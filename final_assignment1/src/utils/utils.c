...
/**
 * \brief Processes the readden chunk
 * 
 * Processes the readden chunk and gets the amount of total words, words starting with vowels and words ending with consonants
 * 
 * \param chunk Pointer to readden chunk
 * \param chunkLenght Length of the chunk(amount of bytes)
 * \param vowel Pointer to vowel counter
 * \param consonant Pointer to consonante counter
 * \param words Pointer to word counter
 */
